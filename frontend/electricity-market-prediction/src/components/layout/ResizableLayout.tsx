...
/**
 * 可拖曳分割版面 | Resizable split-pane layout with drag handle.
 *
 * 支援水平/垂直方向、localStorage 記憶尺寸、受控/非受控模式。
 * Supports horizontal/vertical directions, localStorage persistence,
 * and both controlled and uncontrolled sizing modes.
 */
